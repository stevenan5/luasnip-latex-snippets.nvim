...
function M.retrieve(is_math)
  ...
  return {
    ...
    parse_snippet(
      { trig = "alr", name = "leftangle rightangle" },
      "\\left< ${1:${TM_SELECTED_TEXT}} \\right>$0"
    ),
    parse_snippet(
    ...
    parse_snippet({ trig = "dd", name = "to the ... power ^{}" }, "^{$1}$0 "),
    parse_snippet({ trig = " dr", name = "star superscript ^{*}" }, "^{*}$0 "),
    parse_snippet({ trig = "dr", name = "star superscript ^{*}" }, "^{*}$0 "),
    ...
    parse_snippet({ trig = "qqu", name = "qquad" }, "\\qquad $0"),
    parse_snippet({ trig = "qu", name = "quad" }, "\\quad $0"),
    ...
    parse_snippet({ trig = "pr", name = "Prob" }, "Pr($1) $0"),
    parse_snippet({ trig = "circ", name = "Circle" }, "\\circ "),
  }
end
